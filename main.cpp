...
class Food {
    ...
    {
        Image image = LoadImage("Graphics/banana2.png");
...
int main () 
{
    ...
    InitWindow(2 * offset + cellSize * cellCount, 2 * offset + cellSize * cellCount, "Sarpo | Made By Prith.Stha");
    SetTargetFPS(60);
    ...
    while(WindowShouldClose() == false)
    {
        ...
        DrawText("SARPO", offset -5, 20, 40, darkGreen);
